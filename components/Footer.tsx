    ...
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-[30px] px-6 pb-[20px] pt-[50px] md:px-10 lg:gap-[30px] lg:pb-[67px] lg:pt-[70px] xl:pt-[100px]">
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-12 lg:gap-x-8 lg:gap-y-6 xl:gap-x-10">
          ...
          {/* Rejoignez-nous : rangée d’icônes = même largeur que le titre (grille w-max) */}
          <div className="lg:col-span-2">
            <div className="grid w-max max-w-full gap-y-3">
              ...
              <FooterSocialLink href={site.youtubeUrl} label="YouTube">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="block size-[19px]" aria-hidden>
