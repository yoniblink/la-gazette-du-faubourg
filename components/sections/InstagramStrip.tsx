  ...
  return (
    <section id="suivre" className="scroll-mt-24 bg-[#fafafa] py-20 md:py-24">
      <motion.div
        ...
        className="mx-auto flex max-w-6xl flex-col items-start gap-8 px-6 md:flex-row md:items-center md:justify-between md:px-10"
      >
        <div>
        ...
        <Link
          ...
          className="group flex items-center gap-4 border border-black/[0.1] bg-white px-8 py-5 transition-[border-color,box-shadow] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-black/[0.22] hover:shadow-[0_20px_50px_-24px_rgba(10,10,10,0.18)]"
        >
