...
export function applyElementorArticleLayout(html: string): string {
  ...
  /* WordPress : chaque rangée image|texte est une section verticale (e-con-parent distincts),
     pas un carrousel horizontal — ne pas fusionner les splits consécutifs. */
